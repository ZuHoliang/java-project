...
public class LambdaBuildInTest {
    ...
    public static void main(String[] args) {
        ...
        Function<Person, String>nameFormat = p->(p.getGender()==Gender.MALE?"Mr.":"Ms.")+
        										 p.getLastName();
        ...
        Predicate<Person>ageFormat = p->(p.getAge()<=30);
        ...
        Consumer<Person>personFormat = p -> System.out.printf("%s(%d)%n",p.getFirstName(),p.getAge());
        
        for(Person p:personList) {
        	personFormat.accept(p);
        }        
    }
